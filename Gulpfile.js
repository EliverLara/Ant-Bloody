...
gulp.task('styles', function(done) {
    gulp.src('gtk-3.20/**/*.scss')
        ...
        .pipe(exec(' gsettings set org.gnome.desktop.interface gtk-theme "Bloody"'))
    done();
});
...
gulp.task('shell-style', function(done) {
    gulp.src('gnome-shell/**/*.scss')
        ...
        .pipe(exec('gsettings set org.gnome.shell.extensions.user-theme name "Bloody"'))
    done();
});
...
gulp.task('cinnamon-style', function(done) {
    gulp.src('cinnamon/**/*.scss')
        ...
        .pipe(exec(' gsettings set org.cinnamon.desktop.interface gtk-theme "Bloody"'))
        .pipe(exec(' gsettings set org.cinnamon.desktop.wm.preferences theme "Bloody"'))
        .pipe(exec(' gsettings set org.cinnamon.theme name "Bloody"'))
    done();
});
